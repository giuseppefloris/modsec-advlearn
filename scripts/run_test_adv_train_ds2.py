...
if  __name__ == '__main__':
    ...
    for idx, (model_name, settings) in enumerate(model_settings.items()):
        ...
        if model_name != 'infsvm':
            ...
            adv_trained_adv_y_scores = settings['adv_model'].decision_function(settings['adv_xts_test']) if model_name in ['svc_l1', 'svc_l2'] else settings['adv_model'].predict_proba(settings['adv_xts_test'])[:, 1]
            plot_roc(
                settings['adv_yts'],
